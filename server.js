...
const adminOfferRouter=require('./routes/adminrouter/adminOfferRouter')
const adminSalesRouter=require('./routes/adminrouter/adminSalesRouter')
...
const userRazorpayRouter=require('./routes/userrouter/userRazorpayRouter')
...
app.use('/admin/salesreport',adminSalesRouter)
